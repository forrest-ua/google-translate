...
class GoogleTranslate
  ...
  def call_service url, body
    ...
    accessor.get_response {:url => url, :method => :post, :body => body}, {'User-Agent' => 'Mozilla/5.0 (iPhone; U; CPU iPhone OS 4_3_3 like Mac OS X; en-us) AppleWebKit/533.17.9 (KHTML, like Gecko) Version/5.0.2 Mobile/8J2 Safari/6533.18.5'}
  end
